      ...
      "queries": [
        {
          ...
          "metricSelector": "cloud.aws.authentication.smsSentByAccountIdCountryCodeEnvironmentLogGroupNotifyStatusRegionServiceNameServiceTypeSmsDestinationTypeSmsType:filter(and(eq(environment,${application_environment}),ne(notifystatus,delivered),or(eq(\"aws.account.id\",\"${account_id}\"),eq(\"aws.account.id\",\"${account_id_new}\")),eq(\"smsdestinationtype\",\"DOMESTIC\"))):splitBy(smstype):sort(value(auto,descending)):limit(20)",
          "rate": "NONE",
          "enabled": true
        }
      ],
      ...
      "queries": [
        {
          ...
          "metricSelector": "cloud.aws.authentication.emailNotificationSentByAccountIdApplicationEnvironmentIsTestLogGroupNotificationTypeRegionServiceNameServiceType:filter(and(eq(environment,${application_environment}),or(eq(\"aws.account.id\",\"${account_id}\"),eq(\"aws.account.id\",\"${account_id_new}\")))):splitBy(notificationtype):sort(value(sum,descending)):limit(20)",
          "rate": "NONE",
          "enabled": true
        }
      ],
      ...
      "queries": [
        {
          ...
          "metricSelector": "cloud.aws.authentication.smsSentByAccountIdCountryCodeEnvironmentLogGroupNotifyStatusRegionServiceNameServiceTypeSmsDestinationTypeSmsType:filter(and(eq(environment,${application_environment}),eq(notifystatus,delivered),or(eq(\"aws.account.id\",\"${account_id}\"),eq(\"aws.account.id\",\"${account_id_new}\")),ne(countrycode,44))):splitBy(countrycode,smstype):sum:sort(value(sum,descending)):limit(20)",
          "rate": "NONE",
          "enabled": true
        }
      ],
      ...
      "queries": [
        {
          ...
          "metricSelector": "cloud.aws.authentication.smsSentByAccountIdCountryCodeEnvironmentLogGroupNotifyStatusRegionServiceNameServiceTypeSmsDestinationTypeSmsType:filter(and(eq(environment,${application_environment}),eq(notifystatus,delivered),or(eq(\"aws.account.id\",\"${account_id}\"),eq(\"aws.account.id\",\"${account_id_new}\")),eq(countrycode,44))):splitBy(smstype):sum:sort(value(sum,descending)):limit(20)",
          "rate": "NONE",
          "enabled": true
        }
      ],
